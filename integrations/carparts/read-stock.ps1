...
try{
 ...
 foreach($guid in $guids){
  ...
  $q.CommandText='SELECT GUID,Part,Available,Private,Status,DisplayStatus,EbayStatus,WONum,HoldName,PriceRetail FROM SQLUser.Inventory WHERE Yard=9032 AND GUID=?'
